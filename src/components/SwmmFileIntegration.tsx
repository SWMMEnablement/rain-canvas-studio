...
const allPatterns: Array<{ id: PatternType; name: string; category: string }> = [
  ...
  { id: 'singapore_pub', name: 'Singapore PUB', category: 'Asian' },
  { id: 'china_gb50014', name: 'China GB 50014', category: 'Asian' },
  { id: 'china_prd', name: 'China PRD (Typhoon)', category: 'Asian' },
  { id: 'india_imd', name: 'India IMD (Monsoon)', category: 'Asian' },
  { id: 'india_coastal', name: 'India Coastal (Cyclone)', category: 'Asian' },
  { id: 'japan_amedas', name: 'Japan AMeDAS', category: 'Asian' },
  { id: 'japan_baiu', name: 'Japan Baiu (梅雨)', category: 'Asian' },
  { id: 'japan_typhoon', name: 'Japan Typhoon', category: 'Asian' },
  { id: 'korea_kma', name: 'Korea KMA', category: 'Asian' },
];
