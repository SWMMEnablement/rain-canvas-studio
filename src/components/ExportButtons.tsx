...
export function ExportButtons({ data, pattern, patternKey, totalDepth, duration, timeStep, unitSystem }: ExportButtonsProps) {
  ...
  const exportSwmmDat = () => {
    ...
    // EPA SWMM .dat rainfall file format
    // Uses incremental depth per timestep, station-based columns
    let dat = '';
    ...
    // Use a synthetic start date: 01 Jan 2025 00:00
    ...
    downloadFile(dat, `swmm_rainfall_${pattern.replace(/\s+/g, '_')}.dat`, 'text/plain');
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <div className="flex items-center">
          ...
          <Button
            ...
            onClick={() => {
              navigator.clipboard.writeText(buildSwmmScript());
              setCopiedSwmm(true);
              toast.success("SWMM script copied to clipboard");
              setTimeout(() => setCopiedSwmm(false), 2000);
            }}
          >
        ...
        <div className="flex items-center">
          ...
          <Button
            ...
            title="Copy to clipboard"
            onClick={() => {
              navigator.clipboard.writeText(buildInfoWorksScript());
              setCopiedIcm(true);
              toast.success("InfoWorks ICM profile copied to clipboard");
              setTimeout(() => setCopiedIcm(false), 2000);
            }}
          >
        ...
        <Button onClick={exportSwmmDat} variant="secondary" className="gap-2">
