...
const patternMetadata: Record<PatternType, { name: string; peakPosition: number; description: string }> = {
  ...
  noaa_a14_a: { name: 'NOAA A14 Type A', peakPosition: 0.325, description: 'NOAA Atlas 14 Volume 2 Type A distribution (Ohio Valley & neighboring states, 24-hr). Front-loaded convective-leaning skew.' },
  noaa_a14_b: { name: 'NOAA A14 Type B', peakPosition: 0.425, description: 'NOAA Atlas 14 Volume 2 Type B distribution. Most common Midwest pattern with mid-early sharp peak (~35% time).' },
  noaa_a14_c: { name: 'NOAA A14 Type C', peakPosition: 0.575, description: 'NOAA Atlas 14 Volume 2 Type C distribution. Late-peaked frontal/stratiform-leaning pattern.' },
  noaa_a14_d: { name: 'NOAA A14 Type D', peakPosition: 0.425, description: 'NOAA Atlas 14 Volume 2 Type D distribution. Broad uniform-leaning long-duration profile.' },
  nrcc_a: { name: 'NRCC Type A', peakPosition: 0.325, description: 'Northeast Regional Climate Center Type A distribution from NOAA Atlas 14 Northeast states. Early-peaked.' },
  nrcc_b: { name: 'NRCC Type B', peakPosition: 0.425, description: 'NRCC Type B distribution. Mid-peaked NE pattern matching Atlas 14 Vol 10 cluster B.' },
  nrcc_c: { name: 'NRCC Type C', peakPosition: 0.575, description: 'NRCC Type C distribution. Late-peaked NE pattern.' },
  nrcc_d: { name: 'NRCC Type D', peakPosition: 0.425, description: 'NRCC Type D distribution. Broad/uniform NE long-duration profile.' },
  noaa_ca1: { name: 'NOAA CA Region 1', peakPosition: 0.575, description: 'NOAA Atlas 14 California Region 1 (North Coast). Frontal long-duration distribution.' },
  noaa_ca2: { name: 'NOAA CA Region 2', peakPosition: 0.625, description: 'NOAA Atlas 14 California Region 2 (Sierra Nevada). Orographically enhanced late-peak.' },
  noaa_ca3: { name: 'NOAA CA Region 3', peakPosition: 0.425, description: 'NOAA Atlas 14 California Region 3 (Central Valley). Mid-peaked broad profile.' },
  noaa_ca4: { name: 'NOAA CA Region 4', peakPosition: 0.425, description: 'NOAA Atlas 14 California Region 4 (South Coast). Mid-early peaked frontal storms.' },
  noaa_ca5: { name: 'NOAA CA Region 5', peakPosition: 0.475, description: 'NOAA Atlas 14 California Region 5 (Mojave/Desert). Sharp convective mid-peak.' },
  noaa_ca6: { name: 'NOAA CA Region 6', peakPosition: 0.575, description: 'NOAA Atlas 14 California Region 6 (Sierra East). Late-skewed orographic profile.' },
  nrcs_mse1: { name: 'NRCS MSE 1', peakPosition: 0.325, description: 'NRCS Midwest/Southeast Ensemble MSE 1 (NOAA Atlas 14 Vols 7 & 8). Early-peaked convective.' },
  nrcs_mse2: { name: 'NRCS MSE 2', peakPosition: 0.475, description: 'NRCS MSE 2. Most common Midwest/Southeast mid-peak distribution; modern replacement for SCS Type II.' },
  nrcs_mse3: { name: 'NRCS MSE 3', peakPosition: 0.425, description: 'NRCS MSE 3. Mid-peaked broader-shouldered distribution.' },
  nrcs_mse4: { name: 'NRCS MSE 4', peakPosition: 0.575, description: 'NRCS MSE 4. Late-peaked Midwest/Southeast storm.' },
  nrcs_mse5: { name: 'NRCS MSE 5', peakPosition: 0.625, description: 'NRCS MSE 5. Sharply late-peaked frontal distribution.' },
  nrcs_mse6: { name: 'NRCS MSE 6', peakPosition: 0.425, description: 'NRCS MSE 6. Broad multi-burst long-duration distribution.' },
  hec_freq25: { name: 'HEC-HMS Frequency 25%', peakPosition: 0.325, description: 'HEC-HMS Frequency Storm with 25% intensity position. Nested balanced storm; modern HEC recommendation in place of SCS Type II.' },
  hec_freq50: { name: 'HEC-HMS Frequency 50%', peakPosition: 0.475, description: 'HEC-HMS Frequency Storm with 50% intensity position (centered). Nested balanced design storm.' },
  hec_freq75: { name: 'HEC-HMS Frequency 75%', peakPosition: 0.575, description: 'HEC-HMS Frequency Storm with 75% intensity position. Nested balanced storm with late peak.' },
  sfwmd_72hr: { name: 'SFWMD 72-Hour', peakPosition: 0.425, description: 'South Florida Water Management District 72-hour design storm. Broad multi-day frontal/tropical envelope used for canal & control structure design.' },
  njdep_wq: { name: 'NJDEP WQ 2-Hour', peakPosition: 0.425, description: 'New Jersey DEP Water Quality storm: 1.25 inches over 2 hours, mid-early peak. Used for stormwater quality design under NJAC 7:8.' },
  fdot_type2_mod: { name: 'Type II FL-Modified', peakPosition: 0.475, description: 'Florida-modified SCS Type II distribution. Same general central peak as Type II but adjusted volume distribution for Florida flat-slope hydrology.' },
  austin_z1: { name: 'City of Austin Zone 1', peakPosition: 0.425, description: 'City of Austin Drainage Criteria Manual Zone 1 HEC-HMS frequency storm. Central Texas convective with sharp mid-early peak.' },
  austin_z2: { name: 'City of Austin Zone 2', peakPosition: 0.475, description: 'City of Austin Drainage Criteria Manual Zone 2. Eastern Travis County storm with slightly broader peak.' },
  scs_6hr_std: { name: 'SCS Standard 6-Hour', peakPosition: 0.475, description: 'SCS dimensionless 6-hour standard distribution. Shorter companion to Types I–III; peak at ~50% time. Used for short-duration small-watershed analysis.' },
  hec_area_dep: { name: 'HEC-HMS Area-Dependent', peakPosition: 0.425, description: 'HEC-HMS Area-Dependent hypothetical storm. Applies areal reduction to a depth–duration–frequency distribution for large basins.' },
  dvwk_germany: { name: 'German DVWK', peakPosition: 0.425, description: 'German DVWK (Deutscher Verband für Wasserwirtschaft und Kulturbau) Merkblatt 217 design storm. Distinct from Euler I/II — used for rural and regional drainage in Germany.' },
  vapi_italy: { name: 'Italian VAPI', peakPosition: 0.475, description: 'Italian VAPI (Valutazione delle Piene in Italia) regional flood-rainfall methodology. CNR-GNDCI hierarchical TCEV approach for design hyetographs across Italy.' },
  rioned_nl: { name: 'Netherlands RIONED', peakPosition: 0.425, description: "Stichting RIONED urban-drainage design storms (Buien 01–10 reference set). Standard for Dutch municipal sewer design, distinct from KNMI'14/'23." },
  arr2019_p3: { name: 'ARR 2019 Project 3 Regional', peakPosition: 0.425, description: 'Australian Rainfall & Runoff 2019 Project 3 regional temporal patterns. 10 climate regions × point/areal × frequency bins — replaces single ensemble with regionally calibrated set.' },
  hk_dsd_2023: { name: 'HK DSD 2023', peakPosition: 0.475, description: 'Hong Kong Drainage Services Department 2023 update of stormwater drainage manual. Revised IDF tables and temporal pattern with climate-change uplift over DSD 2018.' },
  malaysia_msma2: { name: 'Malaysia MSMA 2nd Ed.', peakPosition: 0.475, description: 'Malaysia Urban Stormwater Management Manual (MSMA) 2nd Edition (2012). Explicit revision with updated IDF, temporal distribution and ARI tables for Peninsular & East Malaysia.' },
  china_pc_method: { name: 'Chinese P&C Method', peakPosition: 0.425, description: 'Chinese Pilgrim-and-Cordery (P&C) average-variability method as used in Chongqing/Yangtze comparison studies. Region-specific average ranked-position pattern.' },
  taiwan_wra: { name: 'Taiwan WRA', peakPosition: 0.575, description: 'Taiwan Water Resources Agency design storm. WRA Hydrologic Design Aid temporal pattern, distinct from CWA (meteorological) and MOIWR (irrigation).' },
};
