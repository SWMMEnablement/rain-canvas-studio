...
const PATTERN_BADGES = [
  ...
  "Alberta Transportation", "Algeria ANRH", "Argentina SMN",
  ...
  "BC MOE Coastal", "Bogotá EAAB", "Bonta USDA", "Brazil ANA", "Budapest Convective", "Bulgarian NIMH",
  ...
  "Malta MRA", "Maricopa FCD", "Marsalek (1978)", "Mauritius MMS", "MCS Storm", "Medicane",
  ...
  "Philippines PAGASA", "Pilgrim-Cordery", "Pilgrim-Cordery (Canada)", "PMP (HMR 51/52)", "PMP WMO Generalized",
  ...
  "Puerto Rico",
  "Qatar Kahramaa", "Quebec MELCCFP", "Cut-Off Low",
