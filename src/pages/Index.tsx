...
const PATTERN_BADGES = [
  ...
  "BC MOE Coastal", "Belarusian TKP", "Belgium IRM", "Belgium Willems", "Beta Distribution",
  "Bimodal Gaussian", "Blaszczyk", "Block Pattern", "Bogotá EAAB", "Bolivia Altiplano",
  ...
  "ECCC IDF", "Ecuador INAMHI", "Egypt HCWW", "Eritrea DME", "Estonian EMHI", "Ethiopia NMA",
  ...
  "G2P Gamma", "Gaussian Storm", "Gauteng WRC", "Georgia NEA", "German DWA", "Ghana GMet",
  "Greece Hellenic", "Guatemala INSIVUMEH",
  ...
  "KOSTRA-DWD", "Kuwait MEW", "Kyrgyzstan Hydromet",
  ...
  "Maldives MMS", "Malta MRA", "Maricopa FCD", "Marsalek (1978)", "Mauritius MMS",
  "MCS Storm", "Medicane", "Mekong MRC", "Mexico CONAGUA", "Moldova SHS",
  "Mongolia NAMEM", "Mononobe (Japan)", "Monsoon Burst", "Montana/Caquot (FR)",
  "Montenegro IHMS", "Morocco DMN", "Mozambique INAM", "Myanmar DMH",
  "Namibia NMS", "Nepal DHM", "Nested Envelope", "Neyman-Scott",
  "Nigeria NiMet", "NOAA Atlas 14", "NOAA Atlas 15", "NOAA Atlas 16",
  "Nocturnal MCS", "North Macedonia HMS", "Norway NVE", "NYC DEP", "NZ NIWA",
  ...
  "Šamaj-Valovič", "Samoa MET", "São Paulo DAEE", "Saudi Arabia PME",
  "SCS Type I", "SCS Type IA", "SCS Type II", "SCS Type III",
  "Sea Breeze", "Serbian RHMZ", "Seychelles SMA", "SHYREG (FR)", "Sifalda (Czech)",
  "Sigmoid Logistic", "Singapore PUB", "Slovenian ARSO", "South Africa SANRAL",
  ...
  "Taiwan CWA", "Tajikistan Hydromet", "Tanzania TMA", "Témez (Spain)", "TENAX-CDS",
